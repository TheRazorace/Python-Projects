...
##Απόδοση της τιμής 1, όπου ο πίνακας πιθανοτήτων έχει 8 και -1 όπου έχει 0
binary_y_train=np.where(binary_y_train == 0,-1 ,binary_y_train)   
binary_y_train=np.where(binary_y_train == 8, 1 ,binary_y_train) 
...
##Απόδοση της τιμής 1, όπου ο πίνακας πιθανοτήτων έχει 8 και -1 όπου έχει 0
binary_y_test=np.where(binary_y_test == 0,-1 ,binary_y_test)   
binary_y_test=np.where(binary_y_test == 8, 1 ,binary_y_test) 
